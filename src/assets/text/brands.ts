const brands = [
  ...
  },
  {
    ...
    packages: [
      ...
      {
        content: "Liqui Moly 5W30 Engine oil and filter",
        img: "turbo-oil.jpg",
      },
      {
        content: "Tough dog suspension and  spring upgrades",
  ...
  {
    value: "Suzuki Swift Sport",
    info: "The Suzuki Swift Sport is an agile choice for hatch-back enthusiasts, known for its compact size and handling capabilities. One way to enhance its performance is by upgrading your turbo, down pipes, exhaust system or remapping your ECU. In addition to the power upgrade, customizing the exhaust system, such as adding a dual exit exhaust, can further enhance the vehicle's performance and sound. Suspension upgrades, like the Tough Dog shock absorbers with custom powder-coated springs, can improve ride comfort and handling. For better safety and control, upgrading the braking system and steering components, is also a valuable addition to a high performance Suzuki Swift build.",
    packages: [
      {
        content: "SG Performance Garrett GT17 Turbo conversion",
        img: "jimny1.jpg",
